한옥 창호 CAD 패키지 / HANOK_GEN_V1_678f9ff89c46
형식: SINGLE LEAF / RIGHT HINGES
외곽: 420 x 900 mm. 창짝 1개, 각각 334 x 814 mm.
크기 기준: 외경(완성 외곽) 420 x 900 mm 입력. 외경 420 x 900, 내경 340 x 820 mm.
창짝당 창살: 세로 2, 가로 6. 교차점 12개.
부품 16, 홈 72, 도그본 32, 결합쌍 36.
원판: 1220 x 900 x 20 mm. 부재 길이는 목리 X 방향.
가공 깊이: 10 mm. 모든 가공은 A면. 공구 지름 6, 도그본 R3.2.
창짝-고정틀 간극 3 mm.
그림: 지정하지 않음.
실제 존재하는 결합 상세: J1, J2, J3, J4V, J4H
경첩 2, 손잡이 1, 캐치 1: 실물 선정 전 참고 위치.
경첩 부재: S01-2/F01-2
손잡이 부재: S01-1

저장 DXF 재검증: 67개 검사 PASS. 검사 ID·기대값·실측값·허용 오차는 validation_report.json.
실측 최소 홈 사이 폭: 78.26666666666654; 가장자리 폭: 16.79999999999995; 잔존 두께: 10.0 mm.
